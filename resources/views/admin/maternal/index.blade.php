...
<script>
    ...
    function openViewModal(record) {
        document.getElementById('modalFullName').textContent = record.display_name;
        document.getElementById('modalAge').textContent = record.age + ' years';
        document.getElementById('modalAddress').textContent = record.display_address;
        document.getElementById('modalContact').textContent = record.display_contact_number;
