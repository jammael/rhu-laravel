            ...
            <div class="px-8 py-8">
                ...
                <form action="{{ route('patients.update', $patient->id) }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="px-4 py-2.5 rounded-lg border border-gray-300 bg-gray-50 text-slate-700">
                        ...
                        <p class="mt-2 text-xs text-slate-500">Category cannot be changed after enrollment</p>
                    </div>
